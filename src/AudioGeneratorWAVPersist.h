...
#ifndef _AUDIOGENERATORWAVP_H
#define _AUDIOGENERATORWAVP_H

#include "AudioGenerator.h"

class AudioGeneratorWAVPersist : public AudioGenerator
{
  public:
    AudioGeneratorWAVPersist();
    virtual ~AudioGeneratorWAVPersist() override;
    ...
    uint32_t getDataOffset() { Serial.println(dataOffset); return dataOffset; }
